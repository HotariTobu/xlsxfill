...
The notation itself is documented in [Syntax](https://hotaritobu.github.io/xlsxfill/dev/syntax.md); real workbooks run
through the library are shown in [Samples](https://hotaritobu.github.io/xlsxfill/dev/samples/).
...
[Syntax](https://hotaritobu.github.io/xlsxfill/dev/syntax.md#errors); the types are described in [API](https://hotaritobu.github.io/xlsxfill/dev/api.md).
