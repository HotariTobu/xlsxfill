...
The notation itself is documented in [Syntax](https://hotaritobu.github.io/xlsxfill/0.1.2/syntax.md); real workbooks run
through the library are shown in [Samples](https://hotaritobu.github.io/xlsxfill/0.1.2/samples/).
...
[Syntax](https://hotaritobu.github.io/xlsxfill/0.1.2/syntax.md#errors); the types are described in [API](https://hotaritobu.github.io/xlsxfill/0.1.2/api.md).
