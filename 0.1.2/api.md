...
One of [BookProblem](https://hotaritobu.github.io/xlsxfill/0.1.2/api.md#xlsxfill.BookProblem),
[SheetProblem](https://hotaritobu.github.io/xlsxfill/0.1.2/api.md#xlsxfill.SheetProblem) or [CellProblem](https://hotaritobu.github.io/xlsxfill/0.1.2/api.md#xlsxfill.CellProblem).
...
Returns:
    One problem per [message](https://hotaritobu.github.io/xlsxfill/0.1.2/api.md#xlsxfill.BaseProblem.message) embedded in the
    output.
